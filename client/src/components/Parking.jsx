  ...
  return (
    <section className=' bg-[#303030] flex justify-center flex-col items-center '>
      <div className='container mx-auto p-4 my-8'>
        <div className='uppercase mt-4 text-3xl font-semibold font-patua text-white'>
          megközelítés
        </div>
        <div className='w-full flex flex-col justify-between px-4 container md:flex-row md:my-10 '>
          <div className='basis-1/2 flex justify-center '>
            <img
              src={parkingPic}
              alt='térkép parkoláshoz'
              className='rounded-lg max-h-[650px] my-4'
            />
          </div>
          <div className='basis-1/2 flex flex-col justify-center text-gray-50 font-poppins font-light text-lg leading-10'>
            <p className='mb-6'>Kedves Vendégeink!</p>
            ...
            <p className='font-semibold mt-8'>
              Cím: 7304 Mánfa Kaposvári út 18
            </p>
